...
const (
	...
	// TraceOutcomeDeferredSpawnGrace marks a demand-driven retirement held back
	// because the pool seat is inside poolSpawnGrace (vn-n5abuk0).
	TraceOutcomeDeferredSpawnGrace TraceOutcomeCode = "deferred_spawn_grace"
